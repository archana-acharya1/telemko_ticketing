...
class DashcamTicketScreen extends StatefulWidget {
  const DashcamTicketScreen({super.key});

  @override
  State<DashcamTicketScreen> createState() => _DashcamTicketScreenState();
}

class _DashcamTicketScreenState extends State<DashcamTicketScreen> {
  ...
  /// Predefined dashcam issues
  final List<String> dashcamIssues = [
    "Live Feed Not Working",
    "Device Offline",
    "App Login Issue",
    "Recording Not Saved",
    "Notifications Not Received",
    "Camera Blurry / Faulty",
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Dashcam Live Ticket"),
        centerTitle: true,
      ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content:
                          Text("Dashcam Ticket Submitted (mock)"),
                        ),
                      );
                    },
                    child: const Text("Submit Dashcam Ticket"),
                  ),
                ),
              ],
            ),
