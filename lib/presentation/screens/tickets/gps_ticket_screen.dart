...
class GPSTicketScreen extends StatefulWidget {
  const GPSTicketScreen({super.key});

  @override
  State<GPSTicketScreen> createState() => _GPSTicketScreenState();
}

class _GPSTicketScreenState extends State<GPSTicketScreen> {
  ...
  final List<String> gpsIssues = [
    "Device Offline",
    "No GPS Signal",
    "Wrong Location Showing",
    "Battery Low / No Power",
    "Device Tampered",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("GPS Issue Ticket"),
        centerTitle: true,
      ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("GPS Ticket Submitted (mock)")),
                      );
                    },
                    child: const Text("Submit GPS Ticket"),
                  ),
                ),
              ],
            ),
